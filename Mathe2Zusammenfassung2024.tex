...
\pretitle{\vspace{-80pt} \fontsize{30}{50} \usefont{OT1}{phv}{b}{n} \TitleRule \color{Black}} % Horizontal rule before the title
	...
	\title{Mathe II - Zusammenfassung} % The title
...
\subfile{Sections/2 Analysis1/2 Analysis1.tex}

\newpage

\subfile{Sections/3 Analysis2/3 Analysis2.tex}

\newpage

\subfile{Sections/4 Differentialgleichungen/4 Differentialgleichungen.tex}
